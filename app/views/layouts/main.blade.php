...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootswatch/3.3.2/journal/bootstrap.min.css"> -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <section id="main-content" class="clearfix1">
                ...
                @if (Session::has('infoMessage'))
                    <div class="alert alert-info" id="fade_message">{{{ Session::get('infoMessage') }}}</div>
                @endif
                @if (Session::has('warningMessage'))
                    <div class="alert alert-warning" id="fade_message">{{{ Session::get('warningMessage') }}}
               </div>
                @endif
